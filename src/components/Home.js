    ...
    <div id="home" className="page">
        ...
        <div className="container">
          <div className="hero-content">
            <div className="hero-text">
              ...
              <p>Your trusted Southeast Hard Surface Territory Manager for South Florida and Southeast Florida, specializing in Coretec Shaw Floors including Shaw Laminate, Shaw Vinyl, and Shaw Hardwood.</p>
        ...
        <div className="container">
          ...
          <div className="brands-grid">
            <div className="brand-card">
              ...
              <p>100% waterproof, kidproof, petproof luxury vinyl planks and tiles with innovative WPC and SPC construction for extreme durability.</p>
            ...
            <div className="brand-card">
              ...
              <p>Beautiful, durable laminate flooring that delivers the look of hardwood and tile with superior scratch and stain resistance.</p>
              <a href="#" className="btn" onClick={() => handleNavClick('samples')}>Request Samples</a>
            </div>
            <div className="brand-card">
              <h3>
              ...
              <p>Versatile luxury vinyl flooring options that combine style and performance for busy households and commercial spaces.</p>
              <a href="#" className="btn" onClick={() => handleNavClick('samples')}>Request Samples</a>
            </div>
            <div className="brand-card">
              <h3>
              ...
              <p>Engineered hardwood flooring with authentic wood beauty, advanced finishes, and exceptional durability for lasting elegance.</p>
              <a href="#" className="btn" onClick={() => handleNavClick('samples')}>Request Samples</a>
            </div>
          </div>
        </div>
      ...
      <section className="contact-info">
        <div className="container">
          ...
          <p>Email: jason.ranney@shawinc.com | Phone: (561) 451-5880</p>
        </div>
      </section>
    </div>
  );
