          ...
          <div className="about-content">
            <div className="about-text">
              ...
              <h3 style={{ color: '#3b82f6', marginBottom: '1rem' }}>Southeast Hard Surface Territory Manager</h3>
                            ...
                            <p>With expertise in the complete Coretec Shaw Floors family - including Shaw Laminate, Shaw Vinyl, and Shaw Hardwood - I'm committed to helping you grow your business with premium products and exceptional support.</p>
                            <p>Whether you're a flooring retailer, contractor, designer, or distributor, I provide personalized service, technical expertise, and comprehensive product knowledge to ensure your success in the market.</p>
